<?php
	...
	if(isset($_POST['form_sent'])) {
		...
		if(empty($error)) {
			...
			$request->update($req['request_id'], $title, $description, $delivery_date, $amount, $quality);
			header('Location: myrequests.php');
...
<main role="main" class="container">
	<div class="row">
		<div class="col-12 col-md-12 request-col">		
			<h1>Nachfrage <?= htmlentities($req['title']) ?> bearbeiten</h1>
		</div>
	</div>
	<div class="row">
		<div class="col-12 col-md-12">			
			<div class="form-container">
				<form name="edit_request" method="POST" action="" novalidate="">
